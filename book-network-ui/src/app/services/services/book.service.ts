...
import { approvedReturnBook } from '../fn/book/approved-return-book';
import { ApprovedReturnBook$Params } from '../fn/book/approved-return-book';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `approvedReturnBook()` */
  static readonly ApprovedReturnBookPath = '/books/borrow/return/approve/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `approvedReturnBook()` instead.
   *
   * This method doesn't expect any request body.
   */
  approvedReturnBook$Response(params: ApprovedReturnBook$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return approvedReturnBook(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `approvedReturnBook$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  approvedReturnBook(params: ApprovedReturnBook$Params, context?: HttpContext): Observable<number> {
    return this.approvedReturnBook$Response(params, context).pipe(
      map((r: StrictHttpResponse<number>): number => r.body)
    );
  }
