...
public class BookService {
    ...
    public PageResponse<BorrowedBookResponse> findAllBorrowedBooks(int page, int size, Authentication connectedUser) {
        ...
        List<BorrowedBookResponse> borrowedBookResponses = allBorrowedBooks.stream()
                ...
                .toList();
        List<BorrowedBookResponse> bookResponse = List.of();
        return new PageResponse<>(
                bookResponse,
    ...
    public Integer updateShareableSstatus(Integer bookId, Authentication connectedUser) {
...
return bookTransactionHistoryRepository.save(bookTransactionHistory).getId();
    ...
    public Integer approvedReturnBorrowedBook(Integer bookId, Authentication connectedUser) {
        ...
        BookTransactionHistory bookTransactionHistory = bookTransactionHistoryRepository.findByBookIdAndOwnerId(bookId, user.getId())
                .orElseThrow(() -> new OperationNotPermittedException("The book is not returned yet,  So you can not approve it as  returned . "));
